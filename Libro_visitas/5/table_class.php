...
class table {
	private $tag ;
	function Begin($border=1, $align="center", $width='100%', $cellpadding=2,
	$cellspacing=2, $class='', $id='', $bgcolor='#D8F781', $style='')
	 {
		$this->tag = '<table ' ;
	...
	function ColumnOn($colspan=4, $align='left', $width="", $rowspan="",
